# eyebrow verify — GitHub Action

Runs `eyebrow verify --ci` against your committed `eyebrowlock.json`: fails
...
| `trusted-keys` | `eyebrow.trustedkeys` | Trusted-keys registry for `requireSignature` |
