// Mock scan data for the Eyebrow local dashboard.
// In the real product this is produced by the CLI (`eyebrow scan`) and
// written to a lockfile (eyebrow.lock.json). Here we ship realistic
